...
func (self *CacheVar_t[Key_t, Mapped_t]) flush(ts time.Time, keep int, it *cache.Value_t[Key_t, Ttl_t[Mapped_t]]) bool {
...
func (self *CacheVar_t[Key_t, Mapped_t]) Push(ts time.Time, ttl time.Duration, key Key_t, value_init func(*Mapped_t), value_update func(*Mapped_t)) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
...
func (self *CacheVar_t[Key_t, Mapped_t]) Update(ts time.Time, ttl time.Duration, key Key_t, value_update func(*Mapped_t)) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
...
func (self *CacheVar_t[Key_t, Mapped_t]) Refresh(ts time.Time, ttl time.Duration, key Key_t) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
	it, ok = self.cx.FindBack(key)
	if ok {
		it.Value.ts = ts.Add(ttl)
...
func (self *CacheVar_t[Key_t, Mapped_t]) Replace(ts time.Time, key Key_t, value_update func(*Mapped_t)) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
...
func (self *CacheVar_t[Key_t, Mapped_t]) Find(ts time.Time, key Key_t) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
	it, ok = self.cx.Find(key)
	return
}

func (self *CacheVar_t[Key_t, Mapped_t]) Remove(ts time.Time, key Key_t) (it *cache.Value_t[Key_t, Ttl_t[Mapped_t]], ok bool) {
	self.Flush(ts)
